/obj/effect/mob_spawn/ghost_role/human/nsv13/syndicate_crew/
...
/obj/effect/mob_spawn/ghost_role/human/nsv13/syndicate_crew/pilot
...
/obj/effect/mob_spawn/ghost_role/human/nsv13/syndicate_crew/Destroy()
	new/obj/structure/fluff/empty_sleeper/syndicate(get_turf(src))
	return ..()

/obj/effect/mob_spawn/ghost_role/human/nsv13/syndicate_crew/special(mob/living/new_spawn)
	..()
	new_spawn.fully_replace_character_name(null,random_unique_name(gender))

/obj/effect/mob_spawn/ghost_role/human/nsv13/syndicate_crew/Initialize(mapload)
	. = ..()
...
/obj/effect/mob_spawn/ghost_role/human/nsv13/nt_prisoner/
...
/obj/effect/mob_spawn/ghost_role/human/nsv13/nt_prisoner/Destroy()
	new/obj/structure/fluff/empty_sleeper(get_turf(src))
	return ..()

/obj/effect/mob_spawn/ghost_role/human/nsv13/nt_prisoner/special(mob/living/new_spawn)
	..()
	new_spawn.fully_replace_character_name(null,random_unique_name(gender))

/obj/effect/mob_spawn/ghost_role/human/nsv13/nt_prisoner/Initialize(mapload)
	. = ..()
	var/area/A = get_area(src)
	if(A)
