...
/obj/projectile/bullet/aa_round
...
/obj/projectile/bullet/aa_round/heavy //do we even use this anymore?
	damage = 10
	armor_flag = "overmap_heavy"
	spread = 5

/obj/projectile/bullet/mac_relayed_round	//Projectile relayed by all default MAC shells on overmap hit. No difference for AP / others as their values don't really matter on z level.
	icon = 'nsv13/icons/obj/projectiles_nsv.dmi'
	icon_state = "railgun"
...
/obj/projectile/bullet/mac_round
	icon = 'nsv13/icons/obj/projectiles_nsv.dmi'
	icon_state = "railgun"
	name = "artillery round"
	damage = 400
	...
	relay_projectile_type =  /obj/projectile/bullet/mac_relayed_round
...
/obj/projectile/bullet/mac_round/prehit_pierce(atom/target)
	if(isovermap(target))
...
/obj/projectile/bullet/mac_round/Initialize()
	. = ..()
...
/obj/projectile/bullet/proc/stop_homing()
	homing = FALSE

/obj/projectile/bullet/mac_round/ap
	damage = 250
...
/obj/projectile/bullet/mac_round/magneton
	speed = 1.5
	damage = 325
...
/obj/projectile/bullet/mac_round/cannonshot
	name = "cannonball"
	damage = 350
	icon_state = "cannonshot"
	armor_flag = "overmap_medium"

//You somehow loaded a magic entrapment ball into a cannon. This is your reward.
/obj/projectile/bullet/mac_round/cannonshot/admin
	damage = 600
	speed = 3
	armor_flag = "overmap_heavy"
...
/obj/projectile/bullet/mac_round/dirty
	damage = 150
	name = "dirty artillery round"
	relay_projectile_type = /obj/projectile/bullet/delayed_prime/dirty_shell_stage_two


//Delayed priming projectile parent type - useful for a few different kinds of projectiles so why not.
/obj/projectile/bullet/delayed_prime
	icon = 'nsv13/icons/obj/projectiles_nsv.dmi'
	icon_state = "railgun"
...
/obj/projectile/bullet/delayed_prime/on_hit(atom/target, blocked)
	. = ..()
	penetration_fuze -= fuze_trigger_value(target)

/obj/projectile/bullet/delayed_prime/proc/fuze_trigger_value(atom/target)
	return 0

/obj/projectile/bullet/delayed_prime/Move(atom/newloc, dir)
	. = ..()
	if(!.)
		return
...
/obj/projectile/bullet/delayed_prime/proc/is_valid_to_release(atom/newloc)
	return

/obj/projectile/bullet/delayed_prime/proc/release_payload(atom/detonation_location)
	return

//Dirty shell: Stage 2 - z level sludge payload projectile
/obj/projectile/bullet/delayed_prime/dirty_shell_stage_two
	name = "dirty artillery round"
	icon_state = "railgun"
	penetration_fuze = 4

/obj/projectile/bullet/delayed_prime/dirty_shell_stage_two/fuze_trigger_value(atom/target)
	if(!isclosedturf(target))
		return 0
	return 1

/obj/projectile/bullet/delayed_prime/dirty_shell_stage_two/is_valid_to_release(atom/newloc)
...
/obj/projectile/bullet/delayed_prime/dirty_shell_stage_two/release_payload(atom/detonation_location)
	...
	for(var/turf/shootat_turf as() in shootat_turfs)
		if(!prob(DIRTY_SHELL_PELLET_PROB))
			continue
		var/obj/projectile/energy/nuclear_particle/dirty_shell_stage_three/P = new(detonation_turf)
		//Shooting Code:
		//P.random_color_time()
...
/obj/projectile/energy/nuclear_particle/dirty_shell_stage_three
	name = "irradiated pellet"

/obj/projectile/energy/nuclear_particle/dirty_shell_stage_three/on_hit(atom/target, blocked)
	. = ..()
	if(!isturf(target))
		target.AddElement(/datum/element/radioactive, 300, target, 5 MINUTES)
...
/obj/projectile/bullet/delayed_prime/relayed_incendiary_torpedo
	icon_state = "torpedo_hellfire"
	name = "incendiary torpedo"
	penetration_fuze = 2

/obj/projectile/bullet/delayed_prime/relayed_incendiary_torpedo/fuze_trigger_value(atom/target)
	if(isclosedturf(target))
		return 1
...
/obj/projectile/bullet/delayed_prime/relayed_incendiary_torpedo/is_valid_to_release(atom/newloc)
	if(penetration_fuze > 0 || !isopenturf(newloc))
		return FALSE
	return TRUE

/obj/projectile/bullet/delayed_prime/relayed_incendiary_torpedo/release_payload(atom/detonation_location)
	var/turf/detonation_turf = detonation_location
	explosion(detonation_turf, 0, 0, 4, 7, flame_range = 4)
	detonation_turf.atmos_spawn_air("o2=75;plasma=425;TEMP=1000")

/obj/projectile/bullet/delayed_prime/relayed_viscerator_torpedo
	icon_state = "torpedo"
	name = "armoured torpedo"
	penetration_fuze = 3
	damage = 25

/obj/projectile/bullet/delayed_prime/relayed_viscerator_torpedo/fuze_trigger_value(atom/target)
	if(isclosedturf(target))
		return 1
	return 0

/obj/projectile/bullet/delayed_prime/relayed_viscerator_torpedo/is_valid_to_release(atom/newloc)
	if(penetration_fuze > 0 || !isopenturf(newloc))
		return FALSE
	return TRUE

/obj/projectile/bullet/delayed_prime/relayed_viscerator_torpedo/release_payload(atom/detonation_location)
	var/turf/detonation_turf = detonation_location
	new /obj/effect/dummy/lighting_obj(detonation_turf, COLOR_WHITE, 9, 4, 2)
...
/obj/projectile/bullet/railgun_slug
	icon_state = "mac"
	name = "tungsten slug"
	icon = 'nsv13/icons/obj/projectiles_nsv.dmi'
	damage = 150
...
/obj/projectile/bullet/railgun_slug/uranium //Heavier version
	name = "uranium slug"
	damage = 185
	armour_penetration = 10

// I think the idea is that they course-correct slightly, but only once? -Corvid
/obj/projectile/bullet/railgun_slug/process_homing()
	. = ..()
	homing = FALSE

/obj/projectile/bullet/gauss_slug
	icon_state = "gaussgun"
	name = "tungsten round"
	icon = 'nsv13/icons/obj/projectiles_nsv.dmi'
	damage = 80
...
/obj/projectile/bullet/light_cannon_round
	icon_state = "pdc"
...
/obj/projectile/bullet/heavy_cannon_round
	icon_state = "pdc"
...
/obj/projectile/bullet/hailstorm_bullet
	icon_state = "50cal"
...
/obj/projectile/bullet/prototype_bsa
...
/obj/projectile/guided_munition
	obj_integrity = 50
	max_integrity = 50
	density = TRUE
	armor = list("overmap_light" = 10, "overmap_medium" = 0, "overmap_heavy" = 0)

/obj/projectile/guided_munition/torpedo
	icon_state = "torpedo"
	name = "plasma torpedo"
	icon = 'nsv13/icons/obj/projectiles_nsv.dmi'
	speed = 2.75
...
/obj/projectile/guided_munition/torpedo/viscerator
	//icon_state = "???"	- alt sprite would be nice
	name = "armoured torpedo"
	relay_projectile_type = /obj/projectile/bullet/delayed_prime/relayed_viscerator_torpedo
	damage = 75	//Simply kinetic damagewise..
	armor_flag = "overmap_medium"
	obj_integrity = 80
	max_integrity = 80

/obj/projectile/guided_munition/torpedo/shredder
	icon_state = "torpedo_shredder"
	name = "plasma charge"
	damage = 200
	armour_penetration = 40

/obj/projectile/guided_munition/torpedo/decoy
	icon_state = "torpedo"
	damage = 0
	obj_integrity = 200
	max_integrity = 200

/obj/projectile/guided_munition/torpedo/hellfire
	icon_state = "torpedo_hellfire"
	...
	relay_projectile_type = /obj/projectile/bullet/delayed_prime/relayed_incendiary_torpedo

/obj/projectile/guided_munition/torpedo/hellfire/player_version
	damage = 300	//A bit less initial damage to compensate for the /guaranteed/ hellburn effect dealing hefty damage.

/obj/projectile/guided_munition/torpedo/disruptor
...
/obj/projectile/guided_munition/torpedo/disruptor/prototype
...
/obj/projectile/guided_munition/torpedo/dud
	icon_state = "torpedo_dud"
	damage = 0

/obj/projectile/guided_munition/Initialize()
	. = ..()
...
/obj/projectile/guided_munition/proc/windup()
...
/obj/projectile/guided_munition/missile
...
/obj/projectile/guided_munition/on_hit(atom/target, blocked = FALSE)
	..()
	...
	var/obj/projectile/P = target //This is hacky, refactor check_faction to unify both of these. I'm bodging it for now.
...
/obj/projectile/guided_munition/proc/spec_overmap_hit(obj/structure/overmap/target)
	return

/obj/projectile/guided_munition/torpedo/disruptor/spec_overmap_hit(obj/structure/overmap/target)
...
/obj/projectile/guided_munition/torpedo/hellfire/spec_overmap_hit(obj/structure/overmap/target)
	if(length(target.occupying_levels))
...
/obj/projectile/guided_munition/bullet_act(obj/projectile/P)
	. = ..()
	on_hit(P)

/obj/projectile/guided_munition/proc/detonate(atom/target)
	explosion(target, 2, 4, 4)

/obj/projectile/guided_munition/torpedo/disruptor/detonate(atom/target)
...
/obj/projectile/guided_munition/torpedo/nuclear/detonate(atom/target)
...
/obj/projectile/bullet/pdc_round
	icon_state = "pdc"
	name = "PDC round"
	icon = 'nsv13/icons/obj/projectiles_nsv.dmi'
	damage = 15
...
/obj/projectile/beam/laser/heavylaser/phaser
	name = "phaser beam"
	damage = 200
	armor_flag = "overmap_heavy"
...
/obj/projectile/beam/laser/point_defense
	name = "laser pointer"
	damage = 30
	armor_flag = "overmap_light"
	hitscan = TRUE //Extremely powerful in ship combat
