...
/obj/item/fighter_component/secondary/utility/hold/load(obj/structure/overmap/target, atom/movable/AM)
	if(length(contents) >= max_freight || isliving(AM) || istype(AM, /obj/item/fighter_component) || istype(AM, /obj/item/card/id) || istype(AM, /obj/structure/overmap)) //This just causess issues, trust me on this)
		return FALSE
