/datum/job/master_at_arms
	...
	access = list(ACCESS_MAINT_TUNNELS, ACCESS_COMMAND, ACCESS_EVA, ACCESS_CONSTRUCTION, ACCESS_MINERAL_STOREROOM, ACCESS_MUNITIONS, ACCESS_MAA, ACCESS_MUNITIONS_STORAGE, ACCESS_COMBAT_PILOT, ACCESS_TRANSPORT_PILOT, ACCESS_RC_ANNOUNCE, ACCESS_HANGAR)
	minimal_access = list(ACCESS_MAINT_TUNNELS, ACCESS_COMMAND, ACCESS_EVA, ACCESS_CONSTRUCTION, ACCESS_MINERAL_STOREROOM, ACCESS_MUNITIONS, ACCESS_MAA, ACCESS_MUNITIONS_STORAGE, ACCESS_COMBAT_PILOT, ACCESS_TRANSPORT_PILOT, ACCESS_RC_ANNOUNCE, ACCESS_HANGAR)
