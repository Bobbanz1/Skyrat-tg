...
/datum/design/missilebuilder
	...
	materials = list(/datum/material/iron = 10000, /datum/material/glass = 2500, /datum/material/plasma = 10000)
...
/datum/design/slowconveyor
	...
	category = list("Advanced Munitions")
	departmental_flags = DEPARTMENT_BITFLAG_CARGO|DEPARTMENT_BITFLAG_MUNITIONS
...
/datum/design/guidance_system
	...
	materials = list(/datum/material/iron = 500, /datum/material/glass = 250, /datum/material/gold = 300)
...
/datum/design/warhead
	...
	id = "warhead"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 4000, /datum/material/glass = 500, /datum/material/plasma = 4000)
...
/datum/design/bb_warhead
	...
	id = "bb_warhead"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 3000, /datum/material/glass = 500, /datum/material/plasma = 5000, /datum/material/gold = 2000)
...
/datum/design/hellfire_warhead
	...
	id = "hellfire_warhead"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 4000, /datum/material/glass = 1000, /datum/material/plasma = 7500, /datum/material/gold = 1500, /datum/material/uranium = 5000)
...
/datum/design/probe_warhead
	...
	id = "probe_warhead"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 3000, /datum/material/glass = 1000, /datum/material/titanium= 1000, /datum/material/gold=1000)
...
/datum/design/proto_disruption_warhead
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 10000, /datum/material/glass = 1000, /datum/material/plasma = 3000, /datum/material/gold = 1500, /datum/material/uranium = 10000, /datum/material/titanium = 2000, /datum/material/diamond = 200)
