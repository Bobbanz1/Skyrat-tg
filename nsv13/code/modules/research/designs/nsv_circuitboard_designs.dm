...
/datum/design/board/fighter_launcher
	...
	departmental_flags = DEPARTMENT_BITFLAG_MUNITIONS|DEPARTMENT_BITFLAG_ENGINEERING|DEPARTMENT_BITFLAG_CARGO
...
/datum/design/board/fighter_controller
	...
	category = list("Computer Boards")
	departmental_flags = DEPARTMENT_BITFLAG_MUNITIONS|DEPARTMENT_BITFLAG_ENGINEERING
...
/datum/design/board/ord_circuit
	...
	departmental_flags = DEPARTMENT_BITFLAG_ENGINEERING|DEPARTMENT_BITFLAG_MUNITIONS
...
/datum/design/board/helm_circuit
	...
	id = "helm_circuit"
	materials = list(/datum/material/glass = 5000, /datum/material/gold = 1000)
