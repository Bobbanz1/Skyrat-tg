...
/datum/design/ship_firing_electronics
	...
	materials = list(/datum/material/iron = 1000, /datum/material/diamond = 100, /datum/material/titanium = 300)
...
/datum/design/board/naval_artillery_comp
	...
	build_type = PROTOLATHE|IMPRINTER
	materials = list(/datum/material/glass = 2000, /datum/material/gold = 500, /datum/material/diamond=5000)
...
/datum/design/board/deck_gun_autoelevator
	...
	build_type = PROTOLATHE|IMPRINTER
	materials = list(/datum/material/glass = 2000, /datum/material/titanium = 15000, /datum/material/diamond = 5000)
