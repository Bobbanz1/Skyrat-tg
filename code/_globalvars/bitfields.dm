...
DEFINE_BITFIELD(overmap_user_roles, list(
	...
	"OVERMAP_USER_ROLE_GUNNER" = OVERMAP_USER_ROLE_GUNNER,
	"OVERMAP_USER_ROLE_SECONDARY_GUNNER" = OVERMAP_USER_ROLE_SECONDARY_GUNNER,
	"OVERMAP_USER_ROLE_OBSERVER" = OVERMAP_USER_ROLE_OBSERVER,
)) //NSV13 change end.
