...
#define ZTRAITS_STATION list(ZTRAIT_STATION = TRUE, ZTRAIT_BOARDABLE = TRUE)
///Z level traits for Deep Space
#define ZTRAITS_SPACE list(ZTRAIT_LINKAGE = SELFLOOPING, ZTRAIT_DYNAMIC_LEVEL = TRUE, ZTRAIT_BOARDABLE = TRUE)
